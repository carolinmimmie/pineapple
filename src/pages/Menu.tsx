const Menu = () => {
  ...
  const pasta = [
    ...
    },
    {
      ...
      description: "fylld med ricotta och spenat, serveras med smör och salvia",
      price: "185",
    },
    {
  ...
  const sweets = [
    ...
    {
      name: "Panna Cotta",
      description: "med bärkompott",
      price: "85",
    },
    {
      name: "Chokladfondant",
      description: "med vaniljglass",
      price: "105",
    },
    {
      name: "Gelato",
  ...
  return (
    <div className="menu">
      ...
      <div className="menu-row">
        {renderMenuSection("Snacks", snacks)}
        {renderMenuSection("Pizza", pizza)}
      </div>
      <div className="menu-row">
        {renderMenuSection("Pasta", pasta)}
        {renderMenuSection("Sött", sweets)}
      </div>
      <h2>Dryck</h2>
      <div className="menu-row">
        {renderMenuSection("Bubblor", bubbles)}
        {renderMenuSection("Öl", beers)}
      </div>
      <div className="menu-row">
        {renderMenuSection("Rött", red)}
        {renderMenuSection("Vitt", white)}
        {renderMenuSection("Cocktails", cocktails)}
      </div>
    </div>
  );
};
